...
*Arm:* `zonedist/rule` — *outage window:* 2026-07-23T18:00:00 to 2026-07-24T00:00:00 (Thursday, weekday)
...
## Agent ledgers
### agent1
- hit rate per grade: {'high': {'graded': 48, 'scored': 20, 'hits': 0, 'rate': 0.0}, 'mid': {'graded': 951, 'scored': 0, 'hits': 0, 'rate': None}, 'low': {'graded': 84, 'scored': 15, 'hits': 12, 'rate': 0.8}}
- consecutive misses: 1; fuse trips: 11
...
- [R32] agent1 fuse active: routed to baseline this round
