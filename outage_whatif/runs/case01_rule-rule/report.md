...
Stop reason: all tickets resolved; verdict unchanged for 2 rounds after 39 rounds; spend 310.5 of budget 420.0.

## Per-subregion verdicts and deciding claims

| subregion | pop | tier | severe | bottleneck | deciding evidence |
|---|---|---|---|---|---|
| BG | 46 | hole | no | coverage | COV:BG:refuted (0.641, 0.9); ROB:BG:supported (0.232, 0.537); CAP:S2:supported mean=0.263; CAP:S4:supported mean=0.23; CAP:S8:supported mean=0.157 |
...
| 11 | R11:ring_sample:INT:5 | ring_sample | 4.92 | resolve INT:5 | INT:5 |
| 12 | R12:pm_hourly:S8 | pm_hourly | 6.4 | resolve CAP:S8 | CAP:S8 |
| 13 | R13:coverage_densify:COV:V5 | coverage_densify | 1.0 | resolve COV:V5 | COV:V5 |
| 14 | R14:ring_sample:INT:6 | ring_sample | 4.92 | resolve INT:6 | INT:6 |
| 15 | R15:pm_hourly:S9 | pm_hourly | 6.4 | resolve CAP:S9 | CAP:S9 |
| 16 | R16:ring_sample:INT:7 | ring_sample | 4.92 | resolve INT:7 | INT:7 |
...
| 32 | R32:pm_hourly:S2 | pm_hourly | 6.4 | resolve CAP:S2 | CAP:S2 |
...
**Total spent: 310.5 / 420.0**

## Agent ledgers
### agent1
- hit rate per grade: {'high': {'graded': 0, 'scored': 0, 'hits': 0, 'rate': None}, 'mid': {'graded': 471, 'scored': 0, 'hits': 0, 'rate': None}, 'low': {'graded': 0, 'scored': 0, 'hits': 0, 'rate': None}}
...
- [R11] executed R11:ring_sample:INT:5 (sample 4 ring points in sector 5) price=4.92; predicted=clean actual=clean
- [R12] executed R12:pm_hourly:S8 (hourly PRB for S8 over the outage-matched window) price=6.4; predicted=middle_zone actual=support_zone
- [R13] executed R13:coverage_densify:COV:V5 (densify 1 unsampled evidence cells in V5) price=1.0; predicted=clears_theta actual=clears_theta
- [R14] executed R14:ring_sample:INT:6 (sample 4 ring points in sector 6) price=4.92; predicted=clean actual=clean
- [R15] executed R15:pm_hourly:S9 (hourly PRB for S9 over the outage-matched window) price=6.4; predicted=middle_zone actual=support_zone
- [R16] executed R16:ring_sample:INT:7 (sample 4 ring points in sector 7) price=4.92; predicted=clean actual=clean
- [R17] executed R17:bg_sweep:COV:BG (background-grid sweep, 8 points) price=10.93; predicted=falls_below_theta actual=still_straddling
...
- [R32] executed R32:pm_hourly:S2 (hourly PRB for S2 over the outage-matched window) price=6.4; predicted=middle_zone actual=support_zone
