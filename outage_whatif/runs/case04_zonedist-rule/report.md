...
*Arm:* `zonedist/rule` — *outage window:* 2026-07-22T17:00:00 to 2026-07-22T23:00:00 (Wednesday, weekday)
...
## Agent ledgers
### agent1
- hit rate per grade: {'high': {'graded': 30, 'scored': 0, 'hits': 0, 'rate': None}, 'mid': {'graded': 995, 'scored': 0, 'hits': 0, 'rate': None}, 'low': {'graded': 79, 'scored': 47, 'hits': 10, 'rate': 0.213}}
- consecutive misses: 1; fuse trips: 18
