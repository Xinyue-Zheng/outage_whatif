...
*Arm:* `zonedist/rule` — *outage window:* 2026-07-26T10:00:00 to 2026-07-26T16:00:00 (Sunday, sun)
...
## Agent ledgers
### agent1
- hit rate per grade: {'high': {'graded': 8, 'scored': 8, 'hits': 8, 'rate': 1.0}, 'mid': {'graded': 204, 'scored': 0, 'hits': 0, 'rate': None}, 'low': {'graded': 4, 'scored': 4, 'hits': 4, 'rate': 1.0}}
